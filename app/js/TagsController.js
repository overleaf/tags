...
module.exports = {
  ...
  updateTagUserIds(req, res, next) {
    ...
    return TagsRepository.updateTagUserIds(old_user_id, new_user_id, function(
      error
    ) {
      if (error != null) {
        return next(error)
  ...
  addProjectToTag(req, res, next) {
    ...
    return TagsRepository.addProjectToTag(user_id, tag_id, project_id, function(
      error
    ) {
      if (error != null) {
        return next(error)
  ...
  addProjectToTagName(req, res, next) {
    ...
    return TagsRepository.addProjectToTagName(
      user_id,
      name,
      project_id,
      function(error) {
  ...
  removeProjectFromTag(req, res, next) {
    ...
    return TagsRepository.removeProjectFromTag(
      user_id,
      tag_id,
      project_id,
      function(error) {
  ...
  removeProjectFromAllTags(req, res, next) {
    logger.log(
      { user_id: req.params.user_id, project_id: req.params.project_id },
      'removing project from all tags'
    )
    return TagsRepository.removeProjectFromAllTags(
      req.params.user_id,
