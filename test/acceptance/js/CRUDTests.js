...
describe('CRUDTests', function() {
  ...
  before(function(done) {
    return TagsApp.ensureRunning(done)
  })
  ...
  describe('Update', function() {
    ...
    describe('renameTag', function() {
      beforeEach(function(done) {
        ...
        return TagsClient.renameTag(
          this.user_id_1,
          this.user_1_tag_1_id,
          this.tag_1_renamed,
          done
        )
      })
    ...
    describe('adding a project to a tag', function() {
      describe('addProjectToTag', function() {
        beforeEach(function(done) {
          return TagsClient.addProjectToTag(
            this.user_id_1,
            this.user_1_tag_1_id,
            this.project_id_1,
            done
        ...
        return describe('adding a second project to the tag', function() {
          ...
          return it('should have both project ids in the list', function(done) {
            return TagsClient.getUserTags(this.user_id_1, (err, res, body) => {
              ...
              expect(projectIds).to.deep.equal([
                this.project_id_1.toString(),
                this.project_id_2.toString()
              ])
              return done()
            })
          })
      ...
      return describe('addProjectToTagName', function() {
        beforeEach(function(done) {
          return TagsClient.addProjectToTagName(
            this.user_id_1,
            this.tag_1,
            this.project_id_1,
            done
    ...
    describe('removeProjectFromTag', function() {
      beforeEach(function(done) {
        return TagsClient.addProjectToTagName(
          ...
          this.project_id_1,
          () => {
            return TagsClient.removeProjectFromTag(
              this.user_id_1,
              this.user_1_tag_1_id,
              this.project_id_1,
              done
        ...
        return TagsClient.addProjectToTagName(
          ...
          () => {
            return TagsClient.addProjectToTagName(
              ...
              this.project_id_1,
              () => {
                return TagsClient.removeProjectFromAllTags(
                  this.user_id_1,
                  this.project_id_1,
                  done
                )
