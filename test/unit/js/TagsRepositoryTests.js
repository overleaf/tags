...
describe('TagsRepository', function() {
  beforeEach(function() {
    ...
    return (this.repository = SandboxedModule.require(modulePath, {
      requires: {
  ...
  describe('finding users tags', function() {
    return it('should find all the documents with that user id', function(done) {
  ...
  describe('addProjectToTag', function() {
    describe('with a valid tag_id', function() {
      beforeEach(function() {
        ...
        return this.repository.addProjectToTag(
          user_id,
          this.tag_id,
          project_id,
          this.callback
  ...
  describe('addProjectToTagName', function() {
    beforeEach(function() {
      ...
      return this.repository.addProjectToTagName(
        user_id,
        tag_name,
        project_id,
        this.callback
  ...
  describe('updateTagUserIds', function() {
    beforeEach(function() {
      this.updateStub.callsArg(3)
      return this.repository.updateTagUserIds(
        'old-user-id',
        'new-user-id',
        this.callback
      )
  ...
  describe('removeProjectFromTag', function() {
    describe('with a valid tag_id', function() {
      beforeEach(function() {
        this.updateStub.callsArg(2)
        this.tag_id = ObjectId().toString()
        return this.repository.removeProjectFromTag(
          user_id,
          this.tag_id,
          project_id,
          this.callback
  ...
  describe('removeProjectFromAllTags', function() {
    return it('should pull the project id from the tag', function(done) {
      this.updateStub.callsArgWith(3, null)
      return this.repository.removeProjectFromAllTags(
        user_id,
        project_id,
        err => {
          const searchOps = { user_id }
          const insertOperation = { $pull: { project_ids: project_id } }
          this.updateStub
  ...
  return describe('renameTag', function() {
    describe('with a valid tag_id', function() {
      beforeEach(function() {
        ...
        this.tag_id = ObjectId().toString()
        this.name = 'new-name'
        return this.repository.renameTag(
          user_id,
          this.tag_id,
          this.name,
          this.callback
